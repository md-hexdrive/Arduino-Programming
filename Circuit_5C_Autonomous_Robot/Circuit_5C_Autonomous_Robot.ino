 ...
 * distance sensor detects an obstacle less than 10 inches away.
 * 
 * When it detects the obstacle, It will stop, backup, turn to 
 * the right, and then continue driving.
 */
...
//      float lastDistance = 0;
        ...
        delay(250);
        turnRight(45);
  //      while(distance > lastDistance && lastDistance > 10) {
  //        turnRight(10);

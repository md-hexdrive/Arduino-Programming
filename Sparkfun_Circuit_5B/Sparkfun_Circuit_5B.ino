...
const int AIN2 = 8;            //control pin 2 on the motor driver for the right motor
const int PWMA = 9;            //speed control pin on the motor driver for the right motor
...
int switchPin = 2;             //switch to turn the robot on and off
